...
// Perform query
$sql1 = "SELECT employees.FIRST_NAME, employees.LAST_NAME, employees.PHONE_NUMBER, employees.DEPARTMENT_ID,
departments.DEPARTMENT_ID, departments.DEPARTMENT_NAME FROM employees, departments
